...
/**
 * Tela de Cadastro e Consulta de Clientes (Etapa 3).
 */
public class TelaCadastroCliente extends JDialog {
    ...
    public TelaCadastroCliente(JFrame parent) {
        super(parent, "Tropicalzin Cremoso - Cadastro de Clientes", true);
        initComponents();
        carregarTabela();
    }
    ...
    private void initComponents() {
        ...
        pnlHeader.setBackground(new Color(217, 119, 6)); // Laranja Âmbar
        pnlHeader.setBorder(BorderFactory.createEmptyBorder(12, 20, 12, 20));

        JLabel lblTitulo = new JLabel("Cadastro e Fidelização de Clientes");
        ...
        pnlForm.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createTitledBorder(BorderFactory.createLineBorder(new Color(203, 213, 225)), "Dados Pessoais"),
    ...
    private void carregarTabela() {
        ...
        List<Cliente> list = RepositorioMemoria.getInstancia().getClientes();
        for (Cliente c : list) {
